...
@section('content')  
         <div class="single_post_content">
            <h2><span>Tentang Organisasi</span></h2>
...
<div class="single_sidebar">
  <h2><span>Tentang Kami</span></h2>
    <ul class="tag_custom">
      <li><a href="/tentang/organisasi">Tentang Organisasi</a></li>
      <li><a href="/tentang/sejarah">Sejarah</a></li>
      <li><a href="/tentang/visimisi">Visi&Misi</a></li>
      <li><a href="/tentang/tujuan">Tujuan</a></li>
    </ul>
</div>
@endsection